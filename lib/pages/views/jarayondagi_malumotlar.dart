...
class JarayondagiMalumotlar extends StatefulWidget {
  const JarayondagiMalumotlar({super.key});

  @override
  State<JarayondagiMalumotlar> createState() => _JarayondagiMalumotlarState();
}

class _JarayondagiMalumotlarState extends State<JarayondagiMalumotlar> {
