...
class ShowTarix extends StatefulWidget {
  const ShowTarix({super.key});

  @override
  State<ShowTarix> createState() => _ShowTarixState();
}

class _ShowTarixState extends State<ShowTarix> {
  ...
  final List<Map<String, String>> items = [
    {"title": "“XOVANDAMIR HOLDING” MCHJ", "location": "BU-00023"},
    {"title": "“XOVANDAMIR HOLDING” MCHJ", "location": "BU-00023"},
    {"title": "“YUKONIA CORP” RSHJ", "location": "BU-00023"},
  ];
  @override
